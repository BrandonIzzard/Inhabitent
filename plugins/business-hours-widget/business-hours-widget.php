<?php
/**
 * RED WordPress Business Hours Widget
 *
 * The RED Business Hours Widget.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Business_Hours_Widget
 * @author    Brandon Izzard <xbrandoni@gmail.com>
 * @license   GPL-2.0+
 * @link      https://github.com/BrandonIzzard
 * @copyright 2016 Inhabitent Supply Co.
 *
 * @wordpress-plugin
 * Plugin Name:       Business Hours Widget
 * Plugin URI:        http://www.redacademy.com
 * Description:       A custom business hours widget.
 * Version:           1.0.1
 * Author:            Brandon Izzard
 * Author URI:        https://github.com/BrandonIzzard
 * License:           GPL-2.0+
